...
import UpdateCourseModal from "./CourseUpdateModal";
// import your modal
...
export default function CourseUpdateTable({
  limitNumber,
  tableTitle,
}: CourseTableProps) {
              ...
              >
                ...
                <TableCell className="text-center">
                  <button
                    ...
                    className="bg-violet-500 h-10 cursor-pointer hover:bg-violet-800 dark:bg-violet-200 dark:hover:bg-violet-300 text-white dark:text-gray-900 font-bold px-6 py-3 rounded-lg shadow-lg transition-all"
                  >
                    UPDATE
                  </button>
                </TableCell>
